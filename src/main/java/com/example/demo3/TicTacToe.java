/*Emma Hopkins -- creates a tictactoe game which the user is able to play, save, and load previous saved games*/
...
public class TicTacToe extends Application {
    ...
    private void loadGame(Stage primaryStage) {
        ...
        fileChooser.getExtensionFilters().add(
                new FileChooser.ExtensionFilter("Tic-Tac-Toe files", "*.ttt"));
